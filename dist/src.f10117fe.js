...
var Attributes = function () {
  ...
  Attributes.prototype.set = function (updateInfo) {
...
var User = function (_super) {
  ...
  User.buildUser = function (atter) {
    return new User(new Attributes_1.Attributes(atter), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
